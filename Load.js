...
// d3.json("tl_2020_25MA_tabblock20.json", function(error, us) {
    ...
    let load = function(error, data) {
        ...
        for (let i = 0; i < tmpunits.length; i++) {
            ...
            function getRace(race) {
                switch(race) {
                    ...
                    case WHITE_PACIFIC:
                        return "White and Pacific Islander"; 
                    case WHITE_OTHER:
                        return "White and Other";
                    case BLACK_NATIVE:
                    ...
                    case NATIVE_ASIAN:
                        return "Native American and Asian";
                    case NATIVE_PACIFIC:
                    ...
                    case PACIFIC_OTHER:
                        return "Pacific Islander and Other";
                    case THREE_PLUS: 
                        // lavender
                        return "3+ races";
                    default:
            ...
            for (let r = 0; r < races.length; r++) {
                // console.log(races[r]);
                // console.log(parseInt(csvdemographics[i][races[r]]));
                for (let j = 0; j < parseInt(csvdemographics[i][races[r]])/100000; j++) {
                    let coord = genDotCoord(county, maxx, maxy, minx, miny, getRace(races[r]), r);
                    dots.push(coord);
                }
            }
        }
        ...
        link.setAttribute("download", "my_data123.csv");
